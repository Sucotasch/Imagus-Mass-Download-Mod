...
async function registerContentScripts() {
    ...
    try {
        ...
        // script reaches the background ONLY through that dedicated event (the
        ...
        // left the background deaf to its own page for the whole load window and
...
// Live 2026-09-13 21:09 (Chrome): the page found ~180 items while the worker
// took over 8 — the old registration lived at the end of the async
// registerContentScripts(), i.e. beyond an awaited chrome.storage.local.get,
// and everything the page sent during that window was dropped silently (the
// sender cannot tell, see Port.send in common/app.js).
