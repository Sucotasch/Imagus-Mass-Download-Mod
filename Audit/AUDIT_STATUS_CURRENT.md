...
---
*Создан 2026-08-23 консолидацией статусов четырёх аудитов. Новые аудиты дописывать сюда (новая секция), историю не переписывать. Дополнение §9 — 2026-09-11. Дополнение §10 — 2026-09-12 (вечер: `ROWS-1`; ночь: `SUPERSEDE-1`, `SUPERSEDE-2`).*
