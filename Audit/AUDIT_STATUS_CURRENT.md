...
| `ROWS-2` | Высокая доля 403 на `wimg.rule34.xxx` — и в фильтре, и в самой загрузке браузером | **Открыто, нужен живой замер** (не регресс: тот же профиль в логах с 09-08; вероятное ограничение частоты). Без данных правка была бы гаданием | в каждом прогоне ~половина сбоев; `GET/403` + `BROWSER/403`, referer-ретрай проваливается единично |
...
---
*Создан 2026-08-23 консолидацией статусов четырёх аудитов. Новые аудиты дописывать сюда (новая секция), историю не переписывать. Дополнение §9 — 2026-09-11. Дополнение §10 — 2026-09-12.*
