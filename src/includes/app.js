...
var platform = {}, app, Port, cfg, _;

app = {
	name: /*~APP_NAME~*/'Imagus',
	version: /*~APP_VERSION~*/'0.9.8.74'
};
...
if (document instanceof window.HTMLDocument) {
	...
	if (platform.style) {
		...
		platform = {
			...
			'zoom-in': this.chrome && !this.browser || this.mx || this.safari ? '-webkit-zoom-in' : 'zoom-in'
		};
		_ = null;
	}
}
...
Port = {
	...
	send: function(message) {
		try {
			...
			console.warn('Imagus: Could not send message, context likely invalidated.', e);
		}
	}
};
