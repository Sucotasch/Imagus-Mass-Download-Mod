...
> ✅ **ИСПОЛНЕНО** — коммит `f329234` («fix: Errors.txt fixes + upstream v2026.7.25 port», проверено в git).
> Документ — **исторический чеклист**, не to-do. Строка «Наша база сейчас» ниже — снимок на дату плана;
> текущая база ушла вперёд (manifest **2026.8.20.9**, см. `UPSTREAM_820_INTEGRATION_PLAN.md`).
