### ВНИМАНИЕ: Этот скрипт сборки предназначен для легаси MV2 версии (папка src/). ###

Для разработки MV3 версии скрипт сборки не нужен —
загрузите src-mv3-overlay/ (актуальное Chrome-дерево) или src-mv3-overlay-firefox/
(Firefox 136+) как распакованное расширение. Устаревшее дерево src-mv3/ —
только для починки старой стабильной линии.
